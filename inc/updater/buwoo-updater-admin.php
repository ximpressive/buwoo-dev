...
class BuWoo_Updater_Admin {
	...
	function updater() {
		...
		if ( !class_exists( 'EDD_Theme_Updater' ) ) {
			...
			include( dirname( __FILE__ ) . '/buwoo-updater-class.php' );
		}
	...
	function license_page() {
		...
		?>
		<div class="wrap">
			<h2 class="headline"><?php echo sprintf( __( '%s License', 'boutique' ), BUWOO_NAME ); ?></h2>
			<div class="themedd-license-management-wrap">
				<h2 class="themedd-license-management-headline"><?php echo sprintf( __( 'Activate Your %s License Key', 'boutique' ), BUWOO_NAME ); ?></h2>
				<p>
					<?php echo sprintf( __( 'Your license key grants you access to theme updates and support. If your license key is deactivated or expired, your theme will work properly but you will not receive automatic updates.', 'boutique' ) );
					?>
				</p>
				<h3><strong><?php _e( 'License activation instructions', 'boutique' ); ?></strong></h3>
				<ol class="themedd-license-instructions">
					<li><?php _e( 'Enter your license key.', 'boutique' ); ?></li>
					<li><?php _e( 'Click the "Save License Key Changes" button.', 'boutique' ); ?></li>
					<li><?php _e( 'Click the new "Activate License" button.', 'boutique' ); ?></li>
					<li><?php _e( 'You\'re done! The status of your license displays below the License Key field.', 'boutique' ); ?></li>
				</ol>
